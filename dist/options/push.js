...
function _askIfAgreesUploadFiles() {
  _askIfAgreesUploadFiles = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
    var answer;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 2:
            ...
            return _context2.abrupt("return", answer === "Y");
...
function _createImageAndUploadToS() {
  _createImageAndUploadToS = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3() {
    ...
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 11:
            _yield$fs$createTarFi = _context3.sent;
...
function _uploadToS() {
  _uploadToS = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(id, tarFilePath) {
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            _context4.t0 = _nodeFetch["default"];
            _context4.t1 = "http://localhost:3001/api/image/".concat(id);
            _context4.t2 = formData;
            _context4.next = 10;
          ...
          case 10:
            ...
            _context4.next = 15;
            return (0, _context4.t0)(_context4.t1, _context4.t5);
          ...
          case 18:
            ...
            return _context4.abrupt("return", console.error("Missing JWT token while during the request"));
          ...
          case 23:
            ...
            return _context4.abrupt("return", console.error("Sent JWT token was broken or expired"));
...
function _ref() {
  _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5() {
